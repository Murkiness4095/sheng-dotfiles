# Generated by Powerlevel10k configuration wizard on 2025-10-30 at 14:01 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, unicode,
# vertical separators, blurred heads, round tails, 2 lines, disconnected, full frame,
